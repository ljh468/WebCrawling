...
public class OcrController {
	...
	public String getReadforImageText(HttpServletRequest request, HttpServletResponse reponse, ModelMap model,
		...
		// 업로드하는 실제 파일명
		// 다운로드 기능구현시, 임의로 정의된 파일명을 원래대로 만들어주기 위한 목적
		...
		if(ext.equals("jpeg")||ext.equals("jpg")||ext.equals("gif")||ext.equals("png")) {
			...
			pDTO.setExt(ext); // 파일 확장자
			pDTO.setReg_id(reg_id); // 저장되는 경로
